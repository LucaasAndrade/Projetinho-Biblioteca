...
import { AlterarGenero, CadastrarGeneroDB, ConsultarGeneroPorId, ConsultarTodosGeneros, DeletarGeneroBD } from '../../api/genero';
    ...
    async function SalvarClick() {
        try {
            if (Number(id) === 0) {
                ...
                toast.success('Genero alterado com Sucesso ✔', { autoClose: 2000, delay: 0, pauseOnHover: false });
            }
    ...
    async function DeletarGenero(id, nome) {
       alert(`ATENÇÃO! ⚠
        ...
        if (window.confirm(`Deseja mesmo deletar o gênero ${nome} ?`) == true) {
            ...
            toast.success('Genero deletado com sucesso ✔', { autoClose: 2000, delay: 0, pauseOnHover: false });
        } else {
            toast.error('Ação Cancelada! ❌', { autoClose: 2000, delay: 0, pauseOnHover: false });
        }
    ...
    return (
        <main className='page-cadastro-genero'>
            ...
            <section className='info-cadastro'>
                <div className='pagina-genero-titulo'>
                    <hr className='linha' />
                ...
                <div className='fundo-cadastrar'>
                    <div>
                        <p>Gênero:</p>
                        <input className='inp-nome' type='text' placeholder='Novo Gênero' value={nmGenero} onChange={e => setNmGenero(e.target.value)} />
                        ...
                        {generos.map(item =>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span>
                                            <img src='/assets/images/editar.png' onClick={() => AtualizarPagina(item.genero, item.id)} />
                                        </span>
                                    </td>
                                    <td>
                                        <span>
                                            <img src='/assets/images/lixeira.png' onClick={() => DeletarGenero(item.id, item.genero)}/>
                                        </span>
                                    </td>
                                </tr>
